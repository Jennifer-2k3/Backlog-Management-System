...
<body >
 ...
 <tr>
        ...
        <th><div align="center">Examination</div></th>
		<th><div align="center">Subject</div></th>
		<th><div align="center">Ask Query</div></th>
 ...
 <?php
	  ...
	  $qry=mysqli_query($conn,"select * from backk where regno='$regno'");
	$i=1;
      ...
      <tr>
        ...
        <td><div align="center"><?php echo $row['sem'];?></div></td>
		        <td><div align="center"><?php echo $row['sub'];?></div></td>
				<td><div align="center"><a href="query.php?sub=<?php echo $row['sub'];?>">Query Now</a></div></td>
				<td><div align="center"><a href="mark.php?sub=<?php echo $row['sub'];?>">View Marks</a></div></td>
