...
<body >
 ...
 <tr>
		...
		<th><div align="center">Upload Assignmnet</div></th>
 ...
 <?php
	  ...
	  $qry=mysqli_query($conn,"select * from assign where sregno='$regno' and img1=''");
	$i=1;
      ...
      <tr>
        ...
        <td><div align="center"><?php echo $row['dt'];?></div></td>
		 ...
		 <td><div align="center"><a href="upload/<?php echo $row['img'];?>" download>download </a></div></td>
		        <td><div align="center"><a href="ass.php?id=<?php echo $row['id'];?>">Upload</a></div></td>
