...
$qry1=mysqli_query($conn,"select * from cla where uname='$uname' ");
...
$qry=mysqli_query($conn,"insert into cla values('','$dep','$year','$sec','$uname','$pass')");
	if($qry){
...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
  ...
  <table width="35%" border="0" align="center">
    ...
    <tr>
      <td height="40" colspan="2"  align="center" ><div class="style5"><h3>Add Section</h></div></td>
    </tr>
