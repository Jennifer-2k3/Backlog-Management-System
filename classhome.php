...
<body >
 ...
 <?php
	  ...
	  $qry=mysqli_query($conn,"select distinct(sub) from backk where dep='$cdep' && year='$cyear' && sec='$csec'");
	$i=1;
      ...
      <tr>
        ...
        <td><div align="center"><?php echo $i;?></div></td>
		        ...
		        <td><div align="center"><a href="viewstu.php?sub=<?php echo $row['sub'];?>"><?php echo $row['sub'];?></a></div></td>
